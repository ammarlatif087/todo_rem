class Todos {
  ...
  Todos(this._title, this._date, this._priority, this._description);
  ...
  // Converting todo object to a map object, and a map object is returened
  ...
  Todos.fromMapObject(Map<String, dynamic> map) {
    _id = map['id'];
    _title = map['title'];
